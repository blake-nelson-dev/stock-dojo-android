...
public final class AppConfig {
    ...
    public static final String CLASSROOM_CHAT_WEBSOCKET_URL = "";
    public static final String SEARCH_WEBSOCKET_URL = "";
    public static final String PORTFOLIO_WEBSOCKET_URL = "";
